...
const DashboardRoom = () => {
  ...
  const [countRented, setCountRented] = useState('')
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        setCountPending(res.data.data.pendingRoom)
        setCountLive(res.data.data.liveRoom)
        setCountRented(res.data.data.rentedRoom)
        console.log(res.data.data.rentedRoom, 'data api');
